...
pub(super) mod oracles {
    ...
    /// literal `#[cfg(test)] mod tests;` declares. The crate declares six more,
    ...
    /// names alone would pass if the derivation grew a twenty-third nobody
    /// looked at.
    pub(in crate::effects::tests) fn the_whole_file_modules_are_read_from_the_declarations() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                "rundir/scratch_tree.rs".to_owned(),
                "runner/container/fake.rs".to_owned(),
                "workspace_manager/fixture.rs".to_owned(),
            ],
        ...
        // **The two halves of the twenty-two, separated.** The count above is
        // satisfied by any twenty-two files; these two say *how* each was reached,

...
| PR7-STD-PRIVATE-ROOT-LEXICAL-COMPARE | The explicit private-root comparison falls back to lexical equality on every canonicalization error (`src/engine/topology/recover.rs`) | project owner | **Raised by the standards review of `3e5212d` and routed here rather than to the cleanliness sweep.** It cites §8's MUST-tagged bullet — *"Path containment checks MUST account for `..`, absolute paths, symlinks/reparse points… Lexical normalization alone does not prove filesystem containment"* — on a security boundary. `CODING_STANDARDS.md` §1 admits a SHOULD deviation on a concrete reason in the code but requires a MUST deviation to carry *"an explicit, reviewed change to this standard or to the controlling design—not an ad hoc exception"*, so the in-code rationale that discharges the sibling lossy-path class does not discharge this one — and this site *is* documented, which is the point: the same evidence settles a SHOULD and cannot settle a MUST. Open until the owner either rules the boundary adequate as designed, amends the standard, or schedules the repair. Region sha256 `31b6eba9705daa9e949c4ed66696e6e9c09e763fda1f75230333ab61072eafb4`, salvageable by hash per W10.4. |
| PR7-STD-OWNER-RECORD-LEXICAL-AUTH | Owner-record public-directory authentication falls back to lexical spelling when canonical evidence is unavailable (`src/engine/topology/recover.rs`) | project owner | **Raised by the standards review of `3e5212d` and routed here rather than to the cleanliness sweep.** It cites §8's MUST-tagged bullet — *"Path containment checks MUST account for `..`, absolute paths, symlinks/reparse points… Lexical normalization alone does not prove filesystem containment"* — on a security boundary. `CODING_STANDARDS.md` §1 admits a SHOULD deviation on a concrete reason in the code but requires a MUST deviation to carry *"an explicit, reviewed change to this standard or to the controlling design—not an ad hoc exception"*, so the in-code rationale that discharges the sibling lossy-path class does not discharge this one — and this site *is* documented, which is the point: the same evidence settles a SHOULD and cannot settle a MUST. Open until the owner either rules the boundary adequate as designed, amends the standard, or schedules the repair. Region sha256 `388c5fbd6fab41a9c3fc9abb90aa0796b9953e2a418fdeb0dc61fd27fa8014bd`, salvageable by hash per W10.4. |
| PR7-STD-PRIVATE-ROOT-NO-CONTAINMENT | The recorded private-root locator is accepted without absolute-path or symlink/reparse-point containment validation (`src/engine/topology/recover.rs`) | project owner | **Raised by the standards review of `3e5212d` and routed here rather than to the cleanliness sweep.** It cites §8's MUST-tagged bullet — *"Path containment checks MUST account for `..`, absolute paths, symlinks/reparse points… Lexical normalization alone does not prove filesystem containment"* — on a security boundary. `CODING_STANDARDS.md` §1 admits a SHOULD deviation on a concrete reason in the code but requires a MUST deviation to carry *"an explicit, reviewed change to this standard or to the controlling design—not an ad hoc exception"*, so the in-code rationale that discharges the sibling lossy-path class does not discharge this one — and this site *is* documented, which is the point: the same evidence settles a SHOULD and cannot settle a MUST. Open until the owner either rules the boundary adequate as designed, amends the standard, or schedules the repair. Region sha256 `f2aa6763a72ff901dda7a55bfb71c583343276162706c926334a19363dd73284`, salvageable by hash per W10.4. |
| PR7-STD-QUESTION-PAYLOAD-COMPONENT | The question-payload write boundary interpolates an unvalidated component into an authoritative path (`src/rundir.rs`) | project owner | **Raised by the standards review of `3e5212d` and routed here rather than to the cleanliness sweep.** It cites §8's MUST-tagged bullet — *"Path containment checks MUST account for `..`, absolute paths, symlinks/reparse points… Lexical normalization alone does not prove filesystem containment"* — on a security boundary. `CODING_STANDARDS.md` §1 admits a SHOULD deviation on a concrete reason in the code but requires a MUST deviation to carry *"an explicit, reviewed change to this standard or to the controlling design—not an ad hoc exception"*, so the in-code rationale that discharges the sibling lossy-path class does not discharge this one. Open until the owner either rules the boundary adequate as designed, amends the standard, or schedules the repair. Region sha256 `1e5f413d6388eaee5594a0021c64d13c297671a22cd7b74a34c46b135af94557`, salvageable by hash per W10.4. |
| PR7-STD-ANSWER-STAGING-COMPONENT | The answer staging boundary uses an unvalidated component as part of its write path (`src/rundir.rs`) | project owner | **Raised by the standards review of `3e5212d` and routed here rather than to the cleanliness sweep.** It cites §8's MUST-tagged bullet — *"Path containment checks MUST account for `..`, absolute paths, symlinks/reparse points… Lexical normalization alone does not prove filesystem containment"* — on a security boundary. `CODING_STANDARDS.md` §1 admits a SHOULD deviation on a concrete reason in the code but requires a MUST deviation to carry *"an explicit, reviewed change to this standard or to the controlling design—not an ad hoc exception"*, so the in-code rationale that discharges the sibling lossy-path class does not discharge this one. Open until the owner either rules the boundary adequate as designed, amends the standard, or schedules the repair. Region sha256 `975a3033271821f91216179bae82995fe4a1380a19697e62d18d213aff009859`, salvageable by hash per W10.4. |
| PR7-STD-OWNERSHIP-PROOF-UNCANONICAL | The private-half ownership proof falls back to an uncanonicalized public path when canonicalization evidence is unavailable (`src/rundir.rs`) | project owner | **Raised by the standards review of `3e5212d` and routed here rather than to the cleanliness sweep.** It cites §8's MUST-tagged bullet — *"Path containment checks MUST account for `..`, absolute paths, symlinks/reparse points… Lexical normalization alone does not prove filesystem containment"* — on a security boundary. `CODING_STANDARDS.md` §1 admits a SHOULD deviation on a concrete reason in the code but requires a MUST deviation to carry *"an explicit, reviewed change to this standard or to the controlling design—not an ad hoc exception"*, so the in-code rationale that discharges the sibling lossy-path class does not discharge this one. Open until the owner either rules the boundary adequate as designed, amends the standard, or schedules the repair. Region sha256 `eb0463a6ae63dc8b69740dc416acec8f611e6915a313a72dd9c4216b9947b8c4`, salvageable by hash per W10.4. |
| PR7-STD-CONTAINER-LEXICAL-CONFINEMENT | Confinement uses a lexical prefix comparison as its entire filesystem-containment decision (`src/runner/container/exec.rs`) | project owner | **Raised by the standards review of `3e5212d` and routed here rather than to the cleanliness sweep.** It cites §8's MUST-tagged bullet — *"Path containment checks MUST account for `..`, absolute paths, symlinks/reparse points… Lexical normalization alone does not prove filesystem containment"* — on a security boundary. `CODING_STANDARDS.md` §1 admits a SHOULD deviation on a concrete reason in the code but requires a MUST deviation to carry *"an explicit, reviewed change to this standard or to the controlling design—not an ad hoc exception"*, so the in-code rationale that discharges the sibling lossy-path class does not discharge this one. Open until the owner either rules the boundary adequate as designed, amends the standard, or schedules the repair. Region sha256 `3e0c3df5db999002cfbd6b5ebc0340735f07fa286df13d465f944a1be183e1cb`, salvageable by hash per W10.4. |

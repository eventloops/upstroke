...
| `run.rs:615` cited in a correction that made its own paragraph thirteen lines longer | **Repaired, `765a2f7`.** Named rather than cited by line |
...
| # | defect | repaired |
|---|---|---|
| 1 | §21 cites **`e1e6841`** nine times as round 5's repair commit. That object is **dangling** — the commit was amended into `765a2f7` and §21 was written against the pre-amend sha | repointed, all nine |
...
overwrote the log before it was read, and `PR7-WIN-RACING-ACCESS-ESCAPES` records

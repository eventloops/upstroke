...
and what measurement to demand of it. Carrying a **rated defect** with its rate rather
than a description is §12's precedent — *the word here was "flake" until 2026-08-29, which
contradicted the row's own 2026-08-26 retitle: a bounded retry too short for its platform is
triaged by changing the bound, not by re-running. Terminology only; the row's disposition is
unchanged.*

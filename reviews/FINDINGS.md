...
## 23. S5 CONVERGED — the scoped definition, and the sweep that closed it

**S5 is converged**, and the word is scoped, because an unscoped one would be a claim this
project has spent six rounds learning not to make.
...
`PR7-WIN-RACING-ACCESS-ESCAPES` in §2 is **open, measured, and owned** — two of four

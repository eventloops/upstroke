...
its findings apply to the merged head as-is. The third pass row supersedes
`PR126-OBJECT-CAS-NULL-UNWITNESSED-IN-PARENT-SUITE` above, which stays as written: the witness it
deferred is what the pass required now.

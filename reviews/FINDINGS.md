...
every `workspace_manager` test rests on, and the three topology suites that reach into it, so a
weakness here weakens all of them at once.

**The finding that decided the shape of the change is `135-FIXTURE-AMBIENT-GIT-ENVIRONMENT-\

...
repairs get a fresh pass, non-serious repair-only deltas are owner-verified and disclosed,
anything wider is re-reviewed; the owner's merge is the attestation. See

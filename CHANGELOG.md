...
- The G2 checkpoint: the v0.2 parallel-execution machinery (worktree-per-task isolation, the
  ...
  by explicit schema choice; no `0.2.0` tag (`decisions/2026-08-31-g2-checkpoint-promotion.md`,
  `decisions/2026-08-31-inertness-premise-behavioural.md`).
...
- `upstroke export-decisions <run-id>`: a local, read-only JSONL/CSV projection of a finished run's
  plan and attempt log (`decisions/2026-08-11-export-decisions-schema.md`).
